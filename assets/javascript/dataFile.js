...
const data = {
	...
	showCopy: false,
	properties: [
		{name: 'color-hex-case', desc: 'Specify lowercase or uppercase for hex colors'},
		{name: 'color-hex-length', desc: 'Specify short or long notation for hex colors'},
		{name: 'indentation', desc: 'Specify indentation'},
		{name: 'custom-property-empty-line-before', desc: 'Require or disallow an empty line before custom properties'},
		{name: 'comment-empty-line-before', desc: 'Require or disallow an empty line before comments'},
		{name: 'number-leading-zero', desc: 'Require or disallow a leading zero for fractional numbers less than 1'},
		{name: 'string-quotes', desc: 'Specify single or double quotes around strings'},
		{name: 'color-no-hex', desc: 'Disallow hex colors'},
		{name: 'font-weight-notation', desc: 'Require numeric or named (where possible) font-weight values. Also, when named values are expected, require only valid names'},
		{name: 'number-no-trailing-zeros', desc: 'Disallow trailing zeros in numbers'},
		{name: 'value-keyword-case', desc: 'Specify lowercase or uppercase for keywords values'},
		{name: 'property-case', desc: 'Specify lowercase or uppercase for properties'},
		{name: 'declaration-colon-space-after', desc: 'Require a single space or disallow whitespace after the colon of declarations'},
		{name: 'declaration-colon-space-before', desc: 'Require a single space or disallow whitespace before the colon of declarations'},
		{name: 'selector-no-id', desc: 'Disallow id selectors'}
	],
	data:[
		{
			step: 1,
